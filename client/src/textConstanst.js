const TEXT_CONTANTS = {
  ...
  FOOTER_ITEMS: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Logo Design' },
        { text: 'Taglines' },
        { text: 'Premium Names For Sale' },
        { text: 'Creative Owned Names For Sale' },
        { text: 'Audience Testing' },
        { text: 'Trademark Research & Filling' },
        { text: 'Managed Agency Service' },
      ],
    },
    {
      title: 'LEGAL',
  ...
  SECTION_LIST: [
    ...
    },
    {
      menuName: 'CONTESTS',
      list: [
        { text: 'How it works', url: '/howItWorks', isInnerLink: true },
        { text: 'Pricing' },
        { text: 'Agency service' },
    ...
    },
    {
      ...
      list: [
        { text: 'popular names' },
        { text: 'short names' },
        { text: 'intriguing names' },
        { text: 'names by category' },
        { text: 'visual name search' },
        { text: 'sell your domains' },
      ],
    },
    {
      menuName: 'Blog',
      list: [
        ...
        {
          text: 'poetic devices in business naming',
        },
        { text: 'crowded bar theory' },
        { text: 'all articles' },
      ],
    },
  ],
